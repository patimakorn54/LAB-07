...
Hello!	| ไม่ได้| มีเครื่องหมายทาง ลอจิก	
w*h 	|ไม่ได้ | เครื่องหมายทาง คณิตศาสตร์		
time	| ใช้ได้| 			
do	|ไม่ได้ | เป็น คำสั่ง			
Do	|ใช้ได้ |			
21November	|ไม่ได้ | มีตัวเลขด้านหน้า			
ladkrabang	|ใช้ได้|			
Student ID	|ไม่ได้ | มีเว้นวรรค			
